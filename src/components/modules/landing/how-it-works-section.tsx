...
const STEPS: StepProps[] = [
  ...
  },
  {
    ...
    description: "Take a screenshot, smart-capture a DOM element, paste an image, or record your screen. Console logs and network requests are captured automatically.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-6">
